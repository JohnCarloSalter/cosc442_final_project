...
import com.pLegacy.gameObjects.AutoFirePower;
import com.pLegacy.gameObjects.GameObject;

/**
 * The class <code>AutoFirePowerTest</code> contains tests for the class <code>{@link AutoFirePower}</code>.
 *
 * @generatedBy CodePro at 5/17/15 5:27 PM
 * @author Sean
 * @version $Revision: 1.0 $
 */
public class AutoFirePowerTest {
	/**
	 * Run the AutoFirePower(int,int) constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 5/17/15 5:27 PM
	 */
	@Test
	public void testAutoFirePower_1()
		throws Exception {
		int x = 1;
		int y = 1;

		AutoFirePower result = new AutoFirePower(x, y);
	...
	public void testLoad_1()
		throws Exception {
		AutoFirePower fixture = new AutoFirePower(1, 1);
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(AutoFirePowerTest.class);
	}
}